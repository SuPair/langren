...
public class PlayerSetActivity extends AppCompatActivity implements View.OnClickListener {
      ...
      private EditText game_old_password;//旧密码
      private EditText game_new_password;//新密码
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        game_old_password = (EditText) findViewById(R.id.game_old_password);
        game_new_password = (EditText) findViewById(R.id.game_new_password);
    ...
    public void onClick(View v) {
       switch (v.getId()){
           ...
           case R.id.player_set_complete://完成
            String nickname= game_nickname.getText().toString();//昵称
            String old_password=game_old_password.getText().toString();//旧密码
            String new_password=game_new_password.getText().toString();//新密码
